export const keybindList = [[
    ...
    },
    {
        ...
        "name": "Windows",
        "binds": [
            { "keys": ["Alt", "+", "jikm"], "action": "Focus window in direction" },
            { "keys": ["Alt", "Shift", "+", "jikm"], "action": "Swap window in direction" },
            { "keys": ["Alt", "+", "h"], "action": "Split ratio -" },
            { "keys": ["Alt", "+", "l"], "action": "Split ratio +" },
